...
namespace EntityServices.Services
{
    ...
    /// </summary>
    public interface IEntityCrudService<TEntity> : IStatusGeneric
        where TEntity : class
    {
        /// <summary>
        ...
        Task<TDto> ReadSingleAsync<TDto>(params object[] keys) where TDto : class, ILinkToEntity<TEntity>;

        Task<TEntity> ReadSingleAsync(params object[] keys);
        ...
        Task<TDto> ReadSingleAsync<TDto>(Expression<Func<TDto, bool>> whereExpression) where TDto : class, ILinkToEntity<TEntity>;

        Task<TEntity> ReadSingleAsync(Expression<Func<TEntity, bool>> whereExpression);
        ...
        Task<TDto> CreateAndSaveAsync<TDto>(TDto entityOrDto, string ctorOrStaticMethodName = null) where TDto : class, ILinkToEntity<TEntity>;

        Task<TEntity> CreateAndSaveAsync(TEntity entityOrDto, string ctorOrStaticMethodName = null);
        ...
        Task UpdateAndSaveAsync<TDto>(TDto entityOrDto, string methodName = null) where TDto : class, ILinkToEntity<TEntity>;

        Task UpdateAndSaveAsync(TEntity entityOrDto, string methodName = null);
        ...
        /// <returns></returns>
        Task<TEntity> UpdateAndSaveAsync(JsonPatchDocument<TEntity> patch, params object[] keys);
        ...
        /// <returns></returns>
        Task<TEntity> UpdateAndSaveAsync(JsonPatchDocument<TEntity> patch, Expression<Func<TEntity, bool>> whereExpression);
        ...
        /// <param name="keys">The key(s) value. If there are multiple keys they must be in the correct order as defined by EF Core</param>
        /// <returns>Task, async</returns>
        Task DeleteAndSaveAsync(params object[] keys);
        ...
        /// <param name="keys">The key(s) value. If there are multiple keys they must be in the correct order as defined by EF Core</param>
        /// <returns>Task, async</returns>
        Task DeleteWithActionAndSaveAsyn(Func<DbContext, TEntity, Task<IStatusGeneric>> runBeforeDelete,
            params object[] keys);
        #endregion
        ...
        /// <param name="keys">The key(s) value. If there are multiple keys they must be in the correct order as defined by EF Core</param>
        /// <returns>A task with a single entity or DTO that was found by the keys. If its an entity class then it is tracked</returns>
        TDto ReadSingle<TDto>(params object[] keys) where TDto : class, ILinkToEntity<TEntity>;

        TEntity ReadSingle(params object[] keys);
        ...
        /// <param name="whereExpression">The where expression should return a single instance, otherwise you get a </param>
        /// <returns>A task with a single entity or DTO that was found by the where clause. If its an entity class then it is tracked</returns>
        TDto ReadSingle<TDto>(Expression<Func<TDto, bool>> whereExpression) where TDto : class, ILinkToEntity<TEntity>;

        TEntity ReadSingle(Expression<Func<TEntity, bool>> whereExpression);
        ...
        IQueryable<TDto> ReadManyNoTracked<TDto>() where TDto : class, ILinkToEntity<TEntity>;

        IQueryable<TEntity> ReadManyNoTracked();
        ...
        /// <returns></returns>
        IQueryable<TDto> ProjectFromEntityToDto<TDto>(Func<IQueryable<TEntity>, IQueryable<TEntity>> query)
            where TDto : class, ILinkToEntity<TEntity>;

        IQueryable<TEntity> ProjectFromDtoToEntity<TDto>(Func<IQueryable<TDto>, IQueryable<TDto>> query)
            where TDto : class, ILinkToEntity<TEntity>;
        ...
        /// <returns>It returns a task with the class you provided. It will contain the primary key defined after the database. 
        /// If its a DTO then GenericServices will have copied the keys from the entity added back into the DTO</returns>
        TDto CreateAndSave<TDto>(TDto entityOrDto, string ctorOrStaticMethodName = null) where TDto : class, ILinkToEntity<TEntity>;

        TEntity CreateAndSave(TEntity entityOrDto, string ctorOrStaticMethodName = null);
        ...
        /// <param name="methodName">Optional: you can give the method name to be used for the update, or CrudValues.UseAutoMapper to make it use AutoMapper to update the entity.</param>
        /// <returns>Task, async</returns>
        void UpdateAndSave<TDto>(TDto entityOrDto, string methodName = null) where TDto : class, ILinkToEntity<TEntity>;

        void UpdateAndSave(TEntity entityOrDto, string methodName = null);
        ...
        /// <param name="keys">These are the primary key(s) to access the entity</param>
        /// <returns></returns>
        TEntity UpdateAndSave(JsonPatchDocument<TEntity> patch, params object[] keys);
        ...
        /// <param name="whereExpression">This is a filter command that will return a single entity (or no entity)</param>
        /// <returns></returns>
        TEntity UpdateAndSave(JsonPatchDocument<TEntity> patch, Expression<Func<TEntity, bool>> whereExpression);
        ...
        /// <param name="keys">The key(s) value. If there are multiple keys they must be in the correct order as defined by EF Core</param>
        /// <returns>Task, async</returns>
        void DeleteWithActionAndSave(Func<DbContext, TEntity, Task<IStatusGeneric>> runBeforeDelete,
            params object[] keys);
        #endregion
    }
}
